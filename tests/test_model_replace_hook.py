"""Tests for _make_chat_completion_hook — SSE id/model field replacement.
...
class TestChatCompletionHook:
    """SSE event id/model field replacement tests."""

    # -- Basic replacement --

    def test_basic_replacement(self):
        hook = _make_chat_completion_hook("gpt-4o", "resp-001")
        event = (
    ...
    def test_model_value_with_escaped_quote(self):
        ...
        hook = _make_chat_completion_hook("new-model", "resp-001")
    ...
    def test_unicode_model_name(self):
        hook = _make_chat_completion_hook("模型名", "resp-001")
        event = b'data: {"model":"gpt-4o-2024"}\n\n'
        result = hook(event)
        data = orjson.loads(result.split(b"data: ")[1].strip())
    ...
    def test_model_with_special_chars(self):
        hook = _make_chat_completion_hook('my"model', "resp-001")
    ...
    def test_id_replaced_with_empty_original_model(self):
        ...
        hook = _make_chat_completion_hook("", "resp-001")
    ...
    def test_model_not_replaced_when_original_model_empty(self):
        """With empty original_model, model field passes through unchanged."""
        hook = _make_chat_completion_hook("", "resp-001")
